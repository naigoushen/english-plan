(function () {
  ...
  var WEEK_PLAN = {
    1: { classes: '上午空档，下午有大学外语课', task: '晨读；上午空档精读课文；晚上清当天内容' },
    2: { classes: 'Python 四节 + 高等数学四节', task: '只做晨读' },
    3: { classes: '电工电子两节，另有大学外语课', task: '晨读；下午空档练视听说听力' },
  ...
  var COURSES = {
    1: [['第 3-4 节', '大学外语口语'], ['第 5-6 节', '大学外语I']],
    2: [['第 1-4 节', 'Python 程序设计'], ['第 5-8 节', '高等数学I']],
    3: [['第 1-2 节', '电工电子技术基础'], ['第 3-4 节', '大学外语I'], ['第 7-8 节', '大学外语I']],
  ...
  function renderFooterNote() {
    ...
    var parts = ['周一、周三英语课的具体节次以教务系统为准。'];
