(function () {
  ...
  var COURSES = {
    1: [[5, 6, '大学外语I(英B)', '2216', 3]],
    2: [
      [1, 4, 'Python程序设计', '3509 通用计算机实训室', 3],
      [5, 8, '高等数学I(A)', '5-0308', 5]
    ],
    3: [
      [1, 2, '电工电子技术基础', '3710 数字媒体实训室', 3],
      [3, 4, '大学外语口语I(英)', '4102', 2],
      [9, 10, '大学外语I(英B)', '2216', 3]
    ],
    4: [
      [1, 3, '艺术导论', '4313', 2],
      [5, 6, '思想道德与法治（德法28）', '5-0506', 3],
      [7, 8, '体育I（四78）', '图书馆旁篮球场', 2]
    ],
    5: [
      [1, 2, '思想道德与法治（德法28）', '5-0506', 3],
      [3, 4, '电工电子技术基础', '3307 通用计算机实训室', 3],
      [5, 8, '高等数学I(A)', '5-0308', 5]
    ],
    6: [],
    0: []
  ...
  function courseItem(c) {
    ...
    var meta = el('span', 'course-meta');
    if (c[3]) meta.appendChild(el('span', 'course-room', c[3]));
    if (c[4]) meta.appendChild(el('span', 'course-credit', c[4] + ' 学分'));
    if (meta.childNodes.length) name.appendChild(meta);
    li.appendChild(name);
    return li;
  }
